...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd(array_unique(array_column($cart, 'store_id')));
    ...
    public function add(Request $request)
    {
        ...
        if (session()->has('cart')) {
            //Existindo sessão adiciona este produto na sessão existente
            ...
            //Não existindo sessão cria esta sessão como o primeiro produto
            $products[] = $product;
